<footer id="footer" class="footer bg-black-111">
	      ...
	      <div class="row border-bottom-black">
	        <div class="col-sm-6 col-md-3">
	          <div class="widget dark">
	            <img class="mt-10 mb-20" alt="" src="images/shiv-logo-removebg-preview.png">
	        <!--    <p>Lorem ipsum dolor adipisicing amet, consectetur sit elit. Aspernatur incidihil quo officia.</p> -->
	            <ul class="list-inline mt-5">
	              <li class="m-0 pl-10 pr-10"> <i class="fa fa-map-marker text-theme-colored mr-5"></i> <a class="text-gray" href="#">Arya kanya chowraha,Sipri Bazar, Jhansi, Uttar Pradesh 284003</a> </li>
	              <li class="m-0 pl-10 pr-10"> <i class="fa fa-phone text-theme-colored mr-5"></i> <a class="text-gray" href="#">+91 73177-78215</a> </li>
	              <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope-o text-theme-colored mr-5"></i> <a class="text-gray" href="#">support@shivohamshiv.com</a> </li>
	              <li class="m-0 pl-10 pr-10"> <i class="fa fa-globe text-theme-colored mr-5"></i> <a class="text-gray" href="https://shivohamshiv.com/">www.shivohamshiv.com</a> </li>
	            </ul>
	          </div>
	          <div class="widget dark">
	      ...
	      <div class="container pt-10 pb-0">
	        <div class="row">
	          <div class="col-md-6 sm-text-center">
	            <p class="font-13 text-black-777 m-0">Copyright &copy;2015 Shivoham Shiv. All Rights Reserved</p>
	          </div>
  ...
  <style>
     .contact-float{
        ...
        .contact-float.active .phone,
        .contact-float.active .whatsapp{
        transform:scale(1);
        opacity:1;
        }
    ...
    <div class="contact-float">
        ...
        <!-- Phone -->
        <a href="tel:+917317778215" class="float-btn phone">
            <span class="tooltip">Phone</span>
            <i class="fa fa-phone"></i>
        </a>
    
        <!-- WhatsApp -->
        <a href="https://wa.me/917317778215" target="_blank" class="float-btn whatsapp">
            <span class="tooltip">WhatsApp</span>
            <i class="fa fa-whatsapp"></i>
        </a>
    
        <!-- Toggle Button -->
        <div class="float-btn main-btn">
    ...
    $('.main-btn').click(function(){
        ...
        $('.contact-float').toggleClass('active');
    
        if($('.contact-float').hasClass('active')){
            $('.main-btn i')
