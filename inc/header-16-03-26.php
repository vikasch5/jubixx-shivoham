<header id="header" class="header">
    ...
    <div class="header-nav">
      <div class="header-nav-wrapper navbar-scrolltofixed bg-white">
        <div class="container">
          <nav id="menuzord-right" class="menuzord pink no-bg"><a class="menuzord-brand pull-left flip mb-15" href="index.php"><img src="images/shiv-logo-removebg-preview.png" alt=""></a>
